...
class ConfigLayer(BaseModel):
    ...
    layer_name: str = Field(default="base", alias="name")
    layer_priority: int = Field(default=0, alias="priority")
...
class EnvironmentLayer(ConfigLayer):
    ...
    prefix: str = Field(default="CLUBHOUSE")
    ...
    def __init__(
        ...
        Args:
            name: Name of this layer.
            priority: Priority of this layer.
            prefix: Prefix for environment variables (e.g., "CLUBHOUSE" for "CLUBHOUSE_HOST").
            separator: Separator for environment variables (e.g., "_" for "CLUBHOUSE_HOST").
    ...
    def env_to_key(self, env_name: str) -> str:
        ...
        Returns:
            Configuration key.
        """
        # Handle standard prefix_separator format (e.g., CLUBHOUSE_SETTING)
