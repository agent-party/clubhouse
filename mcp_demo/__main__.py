...
# pragma: no cover
from mcp_demo.core.service_registry import ServiceRegistry
# pragma: no cover
from mcp_demo.services.confluent_kafka_service import (
    KafkaConfig, 
    KafkaMessage, 
    ConfluentKafkaService
)
# pragma: no cover
from mcp_demo.services.kafka_protocol import MessageHandlerProtocol
