...
from mcp_demo.services.confluent_kafka_service import (  # pragma: no cover
    KafkaConfig,
    KafkaMessage,
    ConfluentKafkaService
)
from mcp_demo.services.kafka_protocol import MessageHandlerProtocol  # pragma: no cover
