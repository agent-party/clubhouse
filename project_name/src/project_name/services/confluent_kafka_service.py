...
from project_name.services.kafka_protocol import (
...
from project_name.services.serializers import (
    JSONSerializer, 
    JSONDeserializer,
    AvroSchemaSerializer,
    AvroSchemaDeserializer
)
from project_name.services.schema_registry import ConfluentSchemaRegistry, SchemaRegistryProtocol
