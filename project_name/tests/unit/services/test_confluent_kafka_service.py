...
class TestConfluentKafkaProducer:
    ...
    def mock_producer(self) -> MagicMock:
        ...
        with patch("project_name.services.confluent_kafka_service.Producer") as mock:
...
class TestConfluentKafkaConsumer:
    ...
    def mock_consumer(self) -> MagicMock:
        ...
        with patch("project_name.services.confluent_kafka_service.Consumer") as mock:
...
class TestConfluentKafkaService:
    ...
    def test_init_with_schema_registry_url(self) -> None:
        ...
        # Act
        with patch("project_name.services.confluent_kafka_service.ConfluentSchemaRegistry") as mock:
    ...
    def test_get_producer(self) -> None:
        ...
        # Act
        with patch("project_name.services.confluent_kafka_service.ConfluentKafkaProducer") as mock:
            producer_instance = MagicMock()
            mock.return_value = producer_instance
    ...
    def test_get_consumer(self) -> None:
        ...
        # Act
        with patch("project_name.services.confluent_kafka_service.ConfluentKafkaConsumer") as mock:
            consumer_instance = MagicMock()
            mock.return_value = consumer_instance
    ...
    def test_set_avro_serializer(self) -> None:
        ...
        # Act
        with patch("project_name.services.confluent_kafka_service.SchemaRegistryClient") as client_mock:
            with patch("project_name.services.confluent_kafka_service.AvroSchemaSerializer") as serializer_mock:
                service = ConfluentKafkaService(config=config)
    ...
    def test_set_avro_deserializer(self) -> None:
        ...
        # Act
        with patch("project_name.services.confluent_kafka_service.SchemaRegistryClient") as client_mock:
            with patch("project_name.services.confluent_kafka_service.AvroSchemaDeserializer") as deserializer_mock:
                service = ConfluentKafkaService(config=config)
